/****************************************************************************
 *
 * /home/bat/bat/actiontec_bhr_4_0/rg/os/linux-2.4/arch/arm/mach-ixp425/matecumbe-pci.c
 * 
...
#define IXP425_PCI_INTB_IRQ	IRQ_IXP425_GPIO11
#define IXP425_PCI_INTC_IRQ	IRQ_IXP425_GPIO10
...
#define IXP425_PCI_INTC_GPIO	IXP425_GPIO_PIN_10
...
void __init matecumbe_pci_hw_init(void)
{
	/* Disable PCI clock */
...
void __init matecumbe_pci_init(void *sysdata)
{
#ifdef CONFIG_PCI_RESET
	if (ixp425_pci_is_host())
		matecumbe_pci_hw_init();
#endif
	ixp425_pci_init(sysdata);
}

static int __init matecumbe_map_irq(struct pci_dev *dev, u8 slot, u8 pin)
{
...
struct hw_pci matecumbe_pci __initdata = {
	init:		matecumbe_pci_init,
	swizzle:	common_swizzle,
	map_irq:	matecumbe_map_irq,
};
