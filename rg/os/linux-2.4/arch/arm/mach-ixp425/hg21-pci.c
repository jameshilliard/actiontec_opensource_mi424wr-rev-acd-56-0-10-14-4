/****************************************************************************
 *
 * /home/bat/bat/actiontec_bhr_4_0/rg/os/linux-2.4/arch/arm/mach-ixp425/hg21-pci.c
 * 
...
void __init hg21_pci_hw_init(void)
{
	/* Disable PCI clock */
...
void __init hg21_pci_init(void *sysdata)
{
#ifdef CONFIG_PCI_RESET
...
static int __init hg21_map_irq(struct pci_dev *dev, u8 slot, u8 pin)
{
    switch (pin)
    {
    case 1:
...
struct hw_pci hg21_pci __initdata = {
	init:		hg21_pci_init,
	swizzle:	common_swizzle,
	map_irq:	hg21_map_irq,
};
