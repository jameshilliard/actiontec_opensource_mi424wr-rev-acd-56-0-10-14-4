/****************************************************************************
 *
 * /home/bat/bat/actiontec_bhr_4_0/rg/os/linux-2.4/arch/arm/mach-ixp425/wx5800-pci.c
 * 
...
#define IXP425_PCI_INTA_IRQ	IRQ_IXP425_GPIO10
...
void __init wx5800_pci_init(void *sysdata)
{
#ifdef CONFIG_PCI_RESET
...
static int __init wx5800_map_irq(struct pci_dev *dev, u8 slot, u8 pin)
{
    switch (slot)
    {
    case SLOT_1:
...
struct hw_pci wx5800_pci __initdata = {
	init:		wx5800_pci_init,
	swizzle:	common_swizzle,
	map_irq:	wx5800_map_irq,
};
