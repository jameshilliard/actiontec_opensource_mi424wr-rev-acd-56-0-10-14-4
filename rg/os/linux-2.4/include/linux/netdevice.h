...
#ifdef ACTION_TEC_VIRTUAL_ETH
typedef int (*VETH_RX_HOOK_FUNC)(struct sk_buff **skb, struct net_device *dev);
typedef int (*VETH_TX_HOOK_FUNC)(struct sk_buff **skb, struct net_device *dev);
#endif /* ACTION_TEC_VIRTUAL_ETH */
...
#define HAVE_TX_TIMEOUT
	...
	/* bridge stuff */
#ifdef ACTION_TEC_FASTPATH_IPTV
    void *br_port;          /* Pointer to 'struct bridge_iflist' */
    void *fastpath_port;    /* Pointer to 'Fastpath port/interface' */
#else
	struct net_bridge_port	*br_port;
#endif /* ACTION_TEC_FASTPATH_IPTV */
...
#ifdef ACTION_TEC_VIRTUAL_ETH
    VETH_RX_HOOK_FUNC veth_rx_hook;
    VETH_TX_HOOK_FUNC veth_tx_hook;
#endif /* ACTION_TEC_VIRTUAL_ETH */
};
...
struct softnet_data
{
	...
	int			avg_blog;
	int			input_pkt_qlen;
	struct sk_buff_head	input_pkt_queue[NUM_RECV_QUEUES];
...
extern int		net_rx_lower(struct net_device *dev, struct sk_buff *skb);
extern int		dev_tx_lower(struct net_device *dev, struct sk_buff *skb);
