...
#ifdef ACTION_TEC_TR69_LED
#define SIOCGMIIREG2	0x894B		/* Read MII PHY register. (for ACTION_TEC)	*/
#endif
...
#if 1 /* ACTION_TEC */
#define SIOCGIFSTATS  0x89D0
#endif /* ACTION_TEC */

#define SIOCGIFNEXT	SIOCDEVPRIVATE+5 /* get the first interface index */
