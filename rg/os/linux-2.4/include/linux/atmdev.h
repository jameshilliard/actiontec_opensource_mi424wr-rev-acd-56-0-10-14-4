...
#define ATM_SETESIF	_IOW('a',ATMIOC_ITF+13,struct atmif_sioc)
					/* force interface ESI */
#define ATM_INIT	_IOW('a',ATMIOC_ITF+14,struct atmif_sioc)
					/* start interface */
#define ATM_SHUTDOWN	_IOW('a',ATMIOC_ITF+15,struct atmif_sioc)
					/* stop interface */
#define ATM_SHOWTIME_POLL	_IOW('a',ATMIOC_ITF+16,struct atmif_sioc)
					/* check sync status */
...
#define ATM_PHY_RESET	_IOW('a',ATMIOC_PHYCOM+0,struct atmif_sioc)
					/* reset ADSL phy */
#define ATM_PHY_REGISTER_SET	_IOW('a',ATMIOC_PHYCOM+1,struct atmif_sioc)
					/* set phy register */
#define ATM_PHY_REGISTER_GET	_IOW('a',ATMIOC_PHYCOM+2,struct atmif_sioc)
					/* get phy register */
#define ATM_PHY_INFO_SHOW	_IOW('a',ATMIOC_PHYCOM+3,struct atmif_sioc)
					/* get ADSL information */

#define ATM_PHY_REGISTER_MAX_LEN 256

struct atm_phy_register {
	unsigned int reg;
	unsigned int len;
	char *data;
};
