 ...
 *
 *  $Id: usbdevice_fs.h,v 1.1.1.1 2006/01/20 03:16:30 zjjiang Exp $
 */

/*****************************************************************************/

#if defined(CONFIG_USB) && !defined(_LINUX_USBDEVICE_FS_H)
...
extern struct file_operations usbdevfs_devices_short_fops;
