 ...
 *                     2002 Hebert Valerio Riedel <hvr@gnu.org>
 *
 * This implementation is based upon the implementation found in GnuPG 1.0.7
 *
...
MODULE_DESCRIPTION ("AES (Rijndael) Cipher / CryptoAPI");
#endif
#ifdef MODULE_AUTHOR
MODULE_AUTHOR ("Free Software Foundation, Inc.");
#endif
...
typedef struct {
	...
	u8 keySched[MAXROUNDS + 1][4][4];	/* key schedule         */
	u8 keySched2[MAXROUNDS + 1][4][4];	/* key schedule         */
} aes_key_t;
...
static const u8 T1[256][4] __attribute__((aligned(4))) = {
...
static const u8 T2[256][4] __attribute__((aligned(4))) = {
...
static const u8 T3[256][4] __attribute__((aligned(4))) = {
...
static const u8 T4[256][4] __attribute__((aligned(4))) = {
...
static const u8 T5[256][4] __attribute__((aligned(4))) = {
...
static const u8 T6[256][4] __attribute__((aligned(4))) = {
...
static const u8 T7[256][4] __attribute__((aligned(4))) = {
...
static const u8 T8[256][4] __attribute__((aligned(4))) = {
...
static const u8 U1[256][4] __attribute__((aligned(4))) = {
...
static const u8 U2[256][4] __attribute__((aligned(4))) = {
...
static const u8 U3[256][4] __attribute__((aligned(4))) = {
...
static const u8 U4[256][4] __attribute__((aligned(4))) = {
...
static void
prepare_decryption (aes_key_t * ctx)
{
	int r;
	u8 *w;

	for (r = 0; r < MAXROUNDS + 1; r++) {
		*((u32 *) ctx->keySched2[r][0]) =
		    *((u32 *) ctx->keySched[r][0]);
		*((u32 *) ctx->keySched2[r][1]) =
		    *((u32 *) ctx->keySched[r][1]);
		*((u32 *) ctx->keySched2[r][2]) =
		    *((u32 *) ctx->keySched[r][2]);
		*((u32 *) ctx->keySched2[r][3]) =
		    *((u32 *) ctx->keySched[r][3]);
	}
...
#define rk (ctx->keySched)
	*((u32 *) temp[0]) = *((u32 *) (in)) ^ *((u32 *) rk[0][0]);
	*((u32 *) temp[1]) = *((u32 *) (in + 4)) ^ *((u32 *) rk[0][1]);
	*((u32 *) temp[2]) = *((u32 *) (in + 8)) ^ *((u32 *) rk[0][2]);
	*((u32 *) temp[3]) = *((u32 *) (in + 12)) ^ *((u32 *) rk[0][3]);
	*((u32 *) (out)) = *((u32 *) T1[temp[0][0]])
	    ^ *((u32 *) T2[temp[1][1]])
	    ^ *((u32 *) T3[temp[2][2]])
	    ^ *((u32 *) T4[temp[3][3]]);
	*((u32 *) (out + 4)) = *((u32 *) T1[temp[1][0]])
	    ^ *((u32 *) T2[temp[2][1]])
	    ^ *((u32 *) T3[temp[3][2]])
	    ^ *((u32 *) T4[temp[0][3]]);
	*((u32 *) (out + 8)) = *((u32 *) T1[temp[2][0]])
	    ^ *((u32 *) T2[temp[3][1]])
	    ^ *((u32 *) T3[temp[0][2]])
	    ^ *((u32 *) T4[temp[1][3]]);
	*((u32 *) (out + 12)) = *((u32 *) T1[temp[3][0]])
	    ^ *((u32 *) T2[temp[0][1]])
	    ^ *((u32 *) T3[temp[1][2]])
	    ^ *((u32 *) T4[temp[2][3]]);
	for (r = 1; r < ROUNDS - 1; r++) {
		*((u32 *) temp[0]) = *((u32 *) (out)) ^ *((u32 *) rk[r][0]);
		*((u32 *) temp[1]) = *((u32 *) (out + 4)) ^ *((u32 *) rk[r][1]);
		*((u32 *) temp[2]) = *((u32 *) (out + 8)) ^ *((u32 *) rk[r][2]);
		*((u32 *) temp[3]) =
		    *((u32 *) (out + 12)) ^ *((u32 *) rk[r][3]);
	...
	*((u32 *) temp[0]) = *((u32 *) (out)) ^ *((u32 *) rk[ROUNDS - 1][0]);
	*((u32 *) temp[1]) =
	    *((u32 *) (out + 4)) ^ *((u32 *) rk[ROUNDS - 1][1]);
	*((u32 *) temp[2]) =
	    *((u32 *) (out + 8)) ^ *((u32 *) rk[ROUNDS - 1][2]);
	*((u32 *) temp[3]) =
	    *((u32 *) (out + 12)) ^ *((u32 *) rk[ROUNDS - 1][3]);
	out[0] = T1[temp[0][0]][1];
	out[1] = T1[temp[1][1]][1];
	out[2] = T1[temp[2][2]][1];
	out[3] = T1[temp[3][3]][1];
	...
	out[8] = T1[temp[2][0]][1];
	out[9] = T1[temp[3][1]][1];
	out[10] = T1[temp[0][2]][1];
	out[11] = T1[temp[1][3]][1];
	out[12] = T1[temp[3][0]][1];
	out[13] = T1[temp[0][1]][1];
	out[14] = T1[temp[1][2]][1];
	out[15] = T1[temp[2][3]][1];
	*((u32 *) (out)) ^= *((u32 *) rk[ROUNDS][0]);
	*((u32 *) (out + 4)) ^= *((u32 *) rk[ROUNDS][1]);
	*((u32 *) (out + 8)) ^= *((u32 *) rk[ROUNDS][2]);
	*((u32 *) (out + 12)) ^= *((u32 *) rk[ROUNDS][3]);
#undef rk
...
#define rk  (ctx->keySched2)
	*((u32 *) temp[0]) = *((u32 *) (in)) ^ *((u32 *) rk[ROUNDS][0]);
	*((u32 *) temp[1]) = *((u32 *) (in + 4)) ^ *((u32 *) rk[ROUNDS][1]);
	*((u32 *) temp[2]) = *((u32 *) (in + 8)) ^ *((u32 *) rk[ROUNDS][2]);
	*((u32 *) temp[3]) = *((u32 *) (in + 12)) ^ *((u32 *) rk[ROUNDS][3]);

	*((u32 *) (out)) = *((u32 *) T5[temp[0][0]])
	    ^ *((u32 *) T6[temp[3][1]])
	    ^ *((u32 *) T7[temp[2][2]])
	    ^ *((u32 *) T8[temp[1][3]]);
	*((u32 *) (out + 4)) = *((u32 *) T5[temp[1][0]])
	    ^ *((u32 *) T6[temp[0][1]])
	    ^ *((u32 *) T7[temp[3][2]])
	    ^ *((u32 *) T8[temp[2][3]]);
	*((u32 *) (out + 8)) = *((u32 *) T5[temp[2][0]])
	    ^ *((u32 *) T6[temp[1][1]])
	    ^ *((u32 *) T7[temp[0][2]])
	    ^ *((u32 *) T8[temp[3][3]]);
	*((u32 *) (out + 12)) = *((u32 *) T5[temp[3][0]])
	    ^ *((u32 *) T6[temp[2][1]])
	    ^ *((u32 *) T7[temp[1][2]])
	    ^ *((u32 *) T8[temp[0][3]]);
	...
	/* last round is special */
	*((u32 *) temp[0]) = *((u32 *) (out)) ^ *((u32 *) rk[1][0]);
	*((u32 *) temp[1]) = *((u32 *) (out + 4)) ^ *((u32 *) rk[1][1]);
	*((u32 *) temp[2]) = *((u32 *) (out + 8)) ^ *((u32 *) rk[1][2]);
	*((u32 *) temp[3]) = *((u32 *) (out + 12)) ^ *((u32 *) rk[1][3]);
	out[0] = S5[temp[0][0]];
	out[1] = S5[temp[3][1]];
	out[2] = S5[temp[2][2]];
	out[3] = S5[temp[1][3]];
	...
	out[15] = S5[temp[0][3]];
	*((u32 *) (out)) ^= *((u32 *) rk[0][0]);
	*((u32 *) (out + 4)) ^= *((u32 *) rk[0][1]);
	*((u32 *) (out + 8)) ^= *((u32 *) rk[0][2]);
	*((u32 *) (out + 12)) ^= *((u32 *) rk[0][3]);
#undef rk
