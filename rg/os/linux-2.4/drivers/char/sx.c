 ...
 * Revision history:
 * $Log: sx.c,v $
 * Revision 1.1.1.1  2006/01/20 03:16:18  zjjiang
 * initial release
 *
 * Revision 1.4  2003/09/21 20:07:59  igork
 * merge branch-dev-2421 into dev
 *
 * Revision 1.3.48.1  2003/09/18 21:04:59  igork
...
#define RCS_ID "$Id: sx.c,v 1.1.1.1 2006/01/20 03:16:18 zjjiang Exp $"
