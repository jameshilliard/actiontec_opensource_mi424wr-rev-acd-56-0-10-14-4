...
char zft_src[] __initdata = "$Source: /home/cvsroot/bhr-4.0.16/rg/os/linux-2.4/drivers/char/ftape/zftape/zftape-init.c,v $";
char zft_rev[] __initdata = "$Revision: 1.1.1.1 $";
char zft_dat[] __initdata = "$Date: 2006/01/20 03:16:20 $";
