...
/*
 * $Log: eql.c,v $
 * Revision 1.1.1.1  2006/01/20 03:16:03  zjjiang
 * initial release
 *
 * Revision 1.3  2003/09/21 20:10:34  igork
 * merge branch-dev-2421 into dev
 *
 * Revision 1.2.66.1  2003/09/18 21:09:13  igork
...
static char version[] __initdata = 
	"Equalizer1996: $Revision: 1.1.1.1 $ $Date: 2006/01/20 03:16:03 $ Simon Janes (simon@ncm.com)\n";
