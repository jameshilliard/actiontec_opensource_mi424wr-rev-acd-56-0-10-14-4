...
/*
   static const char RCSid[] = "$Header: /home/cvsroot/bhr-4.0.16/rg/os/linux-2.4/drivers/scsi/scsi.c,v 1.1.1.1 2006/01/20 03:16:08 zjjiang Exp $";
 */
	...
	for (shpnt = scsi_hostlist; shpnt; shpnt = shpnt->next) {
		...
		for (SDpnt = shpnt->host_queue; SDpnt;
			...
			while (!list_empty(&q->queue_head))
			{
			    ...
			    while (end_that_request_first(
				req, 0, kdevname(req->rq_dev)));
