 ...
 *
 * $Id: sysctl_net_ipv4.c,v 1.3 2007/10/24 23:28:30 athill Exp $
 *
...
extern int sysctl_igmp_max_gass_queries;
extern int sysctl_igmp_max_rec_sources;
extern int sysctl_igmp_debug_output;
...
#ifdef ACTION_TEC_IGMPV3
	{NET_IPV4_IGMP_MAX_GASS_QUERIES, "igmp_max_gass_queries",
	&sysctl_igmp_max_gass_queries, sizeof(int), 0644, NULL, &proc_dointvec},
	{NET_IPV4_IGMP_MAX_REC_SOURCES, "igmp_max_rec_sources",
	&sysctl_igmp_max_rec_sources, sizeof(int), 0644, NULL, &proc_dointvec},
	{NET_IPV4_IGMP_DEBUG_OUTPUT, "igmp_debug_output", 
	&sysctl_igmp_debug_output, sizeof(int), 0644, NULL, &proc_dointvec},
#endif /* ACTION_TEC_IGMPV3 */
