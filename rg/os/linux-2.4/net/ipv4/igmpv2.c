 ...
 *
 *	Version: $Id: igmpv2.c,v 1.2 2007/10/24 23:28:29 athill Exp $
 *
 *	Authors:
...
/*
 * Only compile the contents of this file if IGMPv3 is not configured, in 
 * which case we're falling back to this original IGMPv2 code.
 */
...
#ifdef ACTION_TEC_IGMP_PROXY
#define IP_MAX_MEMBERSHIPS 128
#else
#define IP_MAX_MEMBERSHIPS 20
#endif /* ACTION_TEC_IGMP_PROXY */
