...
extern struct seq_operations slabdebug_op;
extern ssize_t slabdebug_write(struct file *, const char *, size_t, loff_t *);
static int slabdebug_open(struct inode *inode, struct file *file)
{
	return seq_open(file, &slabdebug_op);
}
static struct file_operations proc_slabdebug_operations = {
	open:		slabdebug_open,
	read:		seq_read,
	write:		slabinfo_write,
	llseek:		seq_lseek,
...
void __init proc_misc_init(void)
{
	...
	create_seq_entry("slabdebug",S_IWUSR|S_IRUGO,
		&proc_slabdebug_operations);
#endif
#ifdef CONFIG_MODULES
