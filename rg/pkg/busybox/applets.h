...
#  define APPLET_ODDNAME(a,b,c,d) LINK c a
  ...
  #define APPLET_ODDNAME(a,b,c,d) {a,b,c},
...
#endif
#ifdef BB_DUTMP
	APPLET(dutmp, dutmp_main, _BB_DIR_BIN)
#endif
#ifdef BB_ECHO
...
#endif
#ifdef BB_FBSET
	APPLET(fbset, fbset_main, _BB_DIR_BIN)
#endif
#ifdef BB_FDFLUSH
	...
	APPLET(freeramdisk, freeramdisk_main, _BB_DIR_BIN)
#endif
#ifdef BB_FSCK_MINIX
	APPLET_ODDNAME("fsck.minix", fsck_minix_main, _BB_DIR_BIN, fsck_minix)
#endif
#ifdef BB_GETOPT
...
#endif
#ifdef BB_HALT
	APPLET(halt, halt_main, _BB_DIR_BIN)
#endif
#ifdef BB_HEAD
...
#endif
#ifdef BB_IFCONFIG
	APPLET(ifconfig, ifconfig_main, _BB_DIR_BIN)
#endif
#ifdef BB_INIT
	APPLET(init, init_main, _BB_DIR_BIN)
#endif
#ifdef BB_INSMOD
	APPLET(insmod, insmod_main, _BB_DIR_BIN)
#endif
#ifdef BB_KILL
...
#endif
#ifdef BB_KLOGD
	APPLET(klogd, klogd_main, _BB_DIR_BIN)
#endif
#ifdef BB_LENGTH
...
#endif
#ifdef BB_LOGREAD
	APPLET(logread, logread_main, _BB_DIR_BIN)
#endif
#ifdef BB_LS
	APPLET(ls, ls_main, _BB_DIR_BIN)
#endif
#ifdef BB_LSMOD
	APPLET(lsmod, lsmod_main, _BB_DIR_BIN)
#endif
#ifdef BB_MAKEDEVS
	APPLET(makedevs, makedevs_main, _BB_DIR_BIN)
#endif
#ifdef BB_MD5SUM
...
#endif
#ifdef BB_MKFS_MINIX
	APPLET_ODDNAME("mkfs.minix", mkfs_minix_main, _BB_DIR_BIN, mkfs_minix)
#endif
#ifdef BB_MKNOD
	APPLET(mknod, mknod_main, _BB_DIR_BIN)
#endif
#ifdef BB_MKSWAP
	APPLET(mkswap, mkswap_main, _BB_DIR_BIN)
#endif
#ifdef BB_MKTEMP
...
#endif
#ifdef BB_PIVOT_ROOT
 	APPLET(pivot_root, pivot_root_main, _BB_DIR_BIN)
#endif
#ifdef BB_POWEROFF
	APPLET(poweroff, poweroff_main, _BB_DIR_BIN)
#endif
#ifdef BB_PRINTF
...
#endif
#ifdef BB_REBOOT
	APPLET(reboot, reboot_main, _BB_DIR_BIN)
#endif
#ifdef BB_RENICE
...
#endif
#ifdef BB_RMMOD
	APPLET(rmmod, rmmod_main, _BB_DIR_BIN)
#endif
#ifdef BB_ROUTE
 	APPLET(route, route_main, _BB_DIR_BIN)
#endif
#ifdef BB_RPMUNPACK
	APPLET(rpmunpack, rpmunpack_main, _BB_DIR_BIN)
#endif
#ifdef BB_SED
...
#endif
#ifdef BB_SWAPONOFF
	APPLET(swapon, swap_on_off_main, _BB_DIR_BIN)
#endif
#ifdef BB_SYNC
	APPLET(sync, sync_main, _BB_DIR_BIN)
#endif
#ifdef BB_SYSLOGD
	APPLET(syslogd, syslogd_main, _BB_DIR_BIN)
#endif
#ifdef BB_TAIL
...
#endif
#ifdef BB_UPDATE
	APPLET(update, update_main, _BB_DIR_BIN)
#endif
#ifdef BB_UPTIME
...
#endif
#ifdef BB_WATCHDOG
	APPLET(watchdog, watchdog_main, _BB_DIR_BIN)
#endif
#ifdef BB_WC
