...
//#define BB_AR
#ifdef CONFIG_SMALL_FLASH
    #define BB_INSMOD
    #ifndef CONFIG_RG_RGLOADER /* XXX remove when B14316 is fixed */
        #define BB_KILLALL
        #define BB_KILL
    #endif
#else
...
#define BB_INIT
#endif /* CONFIG_RG_GPL */
#ifdef CONFIG_BB_KLOGD
    #define BB_KLOGD
#elif defined (CONFIG_BB_SYSLOGD)
    #define BB_SYSLOGD
#elif defined (CONFIG_BB_INIT)
    #define BB_INIT
#else
#ifdef CONFIG_ENHANCED_BUSYBOX
    #define BB_BASENAME
    #define BB_CLEAR
    #define BB_EXPR
    #define BB_FIND
